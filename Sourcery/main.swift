...
func runCLI() {
    ...
    ) { watcherEnabled, debugParseTree, disableCache, verboseLogging, quiet, prune, visibility, sources, excludeSources, templates, excludeTemplates, output, projectPath, targetName, moduleName, configPath, forceParse, args, modelJsonPath, annotationPrefix, ejsPath in
        do {
