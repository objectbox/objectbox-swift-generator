...
func runCLI() {
    // For ObjectBox: add additional configuration options
    command(
        // For ObjectBox
        Option<Path>("debug-parsetree", default: "", flag: "d", description: "Dump debug output useful in testing the code generator to the given file. Also pins UIDs to a deterministic number sequence. (Only recommended for testing)"),
        ...
        // For ObjectBox
        Option<String>("visibility", default: "", description: "The visibility to give the classes in generated Swift code. Defaults to 'internal'."),
        ...
        // For ObjectBox
        Option<Path>("xcode-project", default: "", description: "Path to Xcode project file that contains your entities."),
        // For ObjectBox
        Option<String>("xcode-target", default: "", description: "The target in our Xcode project to scan the source files of."),
        // For ObjectBox
        Option<String>("xcode-module", default: "", description: "The Swift module for this project."),
        ...
        // For ObjectBox
        Option<Path>("model-json", default: "", description: "Path to JSON file containing model IDs."),
        // For ObjectBox
        Option<String>("annotation-prefix", default: "", description: "Prefix to use for annotations. Defaults to \"objectbox\".")
